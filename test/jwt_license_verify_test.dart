...
void main() {
  test('rejects the retired sample JWT signed by a different key', () {
    const jwt =
    ...
    // This fixture was issued for an earlier public key and also expired in
    // May 2026. Keeping it as an acceptance test made the suite depend on a
    // retired production signing key. Signature acceptance is covered with a
    // freshly generated key pair in jwt_rs256_verifier_test.dart.
    expect(() => v.verify(jwt), throwsFormatException);
  });
}
